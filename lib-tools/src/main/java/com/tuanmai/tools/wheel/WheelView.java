...
public class WheelView extends View {
	...
	private WheelScroller.ScrollingListener scrollingListener = new WheelScroller.ScrollingListener() {
		...
		public void onScroll(int distance) {
			...
			//fresh text color
            viewAdapter.refreshItem(itemsLayout);
            invalidate();
		}
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.mipmap.tools_selector_bar2);
		}
		if (topShadow == null) {
		...
		//setBackgroundResource(R.drawable.lqc_address_selector_bg);
	}
