 ...
 *******************************************************************************/
package com.tuanmai.tools.widget.pullrefresh;
...
import com.tuanmai.tools.widget.pullrefresh.internal.FlipLoadingLayout;
import com.tuanmai.tools.widget.pullrefresh.internal.FrameAnimatLoadingLayout;
import com.tuanmai.tools.widget.pullrefresh.internal.FrameAnimatLoadingLayoutSec;
import com.tuanmai.tools.widget.pullrefresh.internal.LoadingLayout;
import com.tuanmai.tools.widget.pullrefresh.internal.NoneAnimatLoadingLayout;
import com.tuanmai.tools.widget.pullrefresh.internal.RotateLoadingLayout;
import com.tuanmai.tools.widget.pullrefresh.internal.ViewCompat;
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isReadyForPull()) {
                    ...
                    if (absDiff > mTouchSlop
                        ...
                        } else if (mMode.showFooterLoadingLayout()
                                && diff <= -1f
                                && isReadyForPullEnd()) {
                            mLastMotionY = y;
                            mLastMotionX = x;
...
//					smoothScrollTo(0);
    ...
    protected void onReset() {
        ...
        switch (mCurrentMode) {
            case PULL_FROM_END:
                smoothScrollTo(0, getPullToRefreshScrollDuration(), 500, null);
                break;
            case PULL_FROM_START:
                smoothScrollTo(0, getPullToRefreshScrollDuration(), 0, null);
                break;
    ...
    public enum AnimationStyle {
        ...
        public LoadingLayout createLoadingLayout(Context context, Mode mode,
            ...
            switch (this) {
                ...
                case FRAME:
                    return new FrameAnimatLoadingLayout(context, mode,scrollDirection, attrs);
                case NONE:
                    return new NoneAnimatLoadingLayout(context, mode,scrollDirection, attrs);
            }
        }

        public LoadingLayout createLoadingLayoutSec(Context context, Mode mode,
                                                 Orientation scrollDirection, TypedArray attrs) {
            switch (this) {
                case ROTATE:
                default:
                ...
                case FLIP:
                    return new FlipLoadingLayout(context, mode, scrollDirection,attrs);
                case FRAME:
                    return new FrameAnimatLoadingLayoutSec(context, mode,scrollDirection, attrs);
                case NONE:
                    return new NoneAnimatLoadingLayout(context, mode,scrollDirection, attrs);
            }
        }
