...
import com.tuanmai.tools.widget.pullrefresh.internal.EmptyViewMethodAccessor;
import com.tuanmai.tools.widget.pullrefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	private boolean isFirstItemVisible() {
        ...
        if (mRefreshableView.getFirstVisiblePosition() == 0 && top == 0) {
            return true;
        }
        int padding = mRefreshableView.getPaddingTop();
        return mRefreshableView.getFirstVisiblePosition() == 0 && Math.abs(top - padding) <= 8;
    }
