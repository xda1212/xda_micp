...
import com.tuanmai.tools.Utils.systembartint.SystemBarTintManager;
...
public class StatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int colorId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            //判断是否是魅族或者是小米手机4.4以上手机或者是andorid6.0手机
            if (StatusBarUtil.StatusBarLightMode(activity) == 0) {
                tintManager.setStatusBarTintColor(Color.parseColor("#80000000"));
            } else {
    ...
    public static int getStatusBarHeight(Context context) {
        if (statusBarHeight<=0 && null != context) {
