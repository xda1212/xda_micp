...
public class GridLayoutDivider extends RecyclerView.ItemDecoration {
     ...
     */
    public GridLayoutDivider(Context context, int drawableId) {
     ...
     */
    public GridLayoutDivider(Context context, int dividerHeight, int dividerColor) {
        mDividerHeight = dividerHeight;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(ResUtil.getColor(dividerColor));
