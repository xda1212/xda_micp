    ...
    mViewPager.setOffscreenPageLimit(1);
      ...
      mViewPager.post(new Runnable() {
          ...
          public void run() {
              ...
              if(activity instanceof PhotoPagerActivity){
                  if(((PhotoPagerActivity)activity).getAnimEnable()){
                      TranslateAnimation translateAnim = new TranslateAnimation(0f,0f,-600f,0f);
                      translateAnim.setDuration(500);
                      translateAnim.setFillBefore(true);
                      translateAnim.setInterpolator(new AccelerateInterpolator());
                      mViewPager.startAnimation(translateAnim);
                  }
              }
          }
      });
