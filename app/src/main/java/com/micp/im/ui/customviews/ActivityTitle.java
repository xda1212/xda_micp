...
public class ActivityTitle extends RelativeLayout {
    ...
    public ActivityTitle(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mbackgroundColor = ta.getColor(R.styleable.ActivityTitle_titleBackgroundColor, context.getResources().getColor(R.color.white));
            setUpView(context);
        } finally {
            ta.recycle();
        }
    ...
    private void setUpView(Context context) {
        mRootLayout = findViewById(R.id.title_root_layout);
