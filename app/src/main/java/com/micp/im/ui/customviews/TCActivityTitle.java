package com.micp.im.ui.customviews;
...
public class TCActivityTitle extends RelativeLayout {
    ...
    public TCActivityTitle(Context context, AttributeSet attrs) {
        ...
        try {
            titleText = ta.getString(R.styleable.TCActivityTitle_titleText2);
            canBack = ta.getBoolean(R.styleable.TCActivityTitle_canBack2, true);
            backText = ta.getString(R.styleable.TCActivityTitle_backText2);
            moreText = ta.getString(R.styleable.TCActivityTitle_moreText2);
            tvBackImg = ta.getResourceId(R.styleable.TCActivityTitle_titleBackImg2,R.drawable.btn_return);
            textColor = ta.getColor(R.styleable.TCActivityTitle_titleColor2,context.getResources().getColor(R.color.light_gray));
            setUpView(context);
        } finally {
            ta.recycle();
        }
