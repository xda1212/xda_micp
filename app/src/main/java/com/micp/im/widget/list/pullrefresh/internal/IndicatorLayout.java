...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = getResources().getDrawable(R.mipmap.tools_indicator_arrow);
		...
		switch (mode) {
		case PULL_FROM_END:
			inAnimResId = R.anim.tools_slide_in_from_bottom;
			outAnimResId = R.anim.tools_slide_out_to_bottom;
			setBackgroundResource(R.drawable.tools_indicator_bg_bottom);
		...
		case PULL_FROM_START:
			inAnimResId = R.anim.tools_slide_in_from_top;
			outAnimResId = R.anim.tools_slide_out_to_top;
			setBackgroundResource(R.drawable.tools_indicator_bg_top);
			break;
		}
