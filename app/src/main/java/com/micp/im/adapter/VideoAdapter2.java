...
public class VideoAdapter2 extends RecyclerView.Adapter<VideoAdapter2.Vh> {
    ...
    public VideoAdapter2(Context context, List<ActiveBean> userList, boolean isVertical) {
        mContext = context;
        mUserList = userList;
        mInflater = LayoutInflater.from(mContext);
    ...
    public Vh onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mIsVertical) {
            return new Vh(mInflater.inflate(R.layout.items_video_user_vertical, parent, false));
        } else {
    ...
    class Vh extends RecyclerView.ViewHolder {
        ...
        public Vh(View itemView) {
            ...
            if (mIsVertical) {
                city = (TextView) itemView.findViewById(R.id.items_video_user_city);
            }
