...
public class HomePageVideoAdapter extends RecyclerView.Adapter<HomePageVideoAdapter.Vh> {
    ...
    public HomePageVideoAdapter(Context context, List<ActiveBean> userList) {
        mContext = context;
        mUserList = userList;
