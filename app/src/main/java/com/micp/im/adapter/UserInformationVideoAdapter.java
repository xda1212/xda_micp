...
public class UserInformationVideoAdapter extends RecyclerView.Adapter<UserInformationVideoAdapter.Vh> {
    ...
    public UserInformationVideoAdapter(Context context, List<ActiveBean> userList) {
        mContext = context;
        mUserList = userList;
    ...
    public Vh onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Vh(mInflater.inflate(R.layout.items_video_user_information, parent, false));
    }
