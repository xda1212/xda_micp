...
import com.micp.im.ui.customviews.CircleImageTransformation;
...
public class MyChatRoomAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (emMessage.getFrom().equals(mUser.id)) {
            ...
            vh.headImg.setOnClickListener(null);
        } else {
            ...
            vh.headImg.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    UIHelper.showHomePageActivity(mContext, mToUser.id);
                }
            });
        }
