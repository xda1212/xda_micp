package com.micp.im.viewpagerfragment;
...
import com.micp.im.fragment.GuanzhuLiveFragment;
import com.micp.im.fragment.CommunityFragment;
import com.micp.im.fragment.VideoFragment;
...
import com.micp.im.adapter.ViewPageFragmentAdapter;
import com.micp.im.base.BaseFragment;
import com.micp.im.fragment.AttentionFragment;
import com.micp.im.interf.ListenMessage;
import com.micp.im.interf.PagerSlidingInterface;
import com.micp.im.ui.other.PhoneLivePrivateChat;
import com.micp.im.widget.PagerSlidingTabStrip;
...
public class IndexPagerFragment extends BaseFragment implements ListenMessage {
    ...
    private void initView() {
        ...
        viewPageFragmentAdapter.addTab(getString(R.string.hot), "rm", CommunityFragment.class, getBundle());
