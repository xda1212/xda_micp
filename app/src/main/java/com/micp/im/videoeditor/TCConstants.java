package com.micp.im.videoeditor;
...
public class TCConstants {
    ...
    public static final int IMSDK_APPID = 1400213594;

    //COS存储服务相关配置
    public static final String COS_BUCKET = "live-1257068936";
    public static final String COS_APPID  = "1257068936";
    ...
    public static final String CLOUD_API_SECRETID = "AKIDtogpodWPzrDZRArH6lLPszVJ4NX5ngmo";
