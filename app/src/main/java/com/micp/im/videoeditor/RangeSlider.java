...
public class RangeSlider extends ViewGroup {
    ...
    public RangeSlider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLinePaint.setColor(array.getColor(R.styleable.RangeSlider_lineColor2, DEFAULT_LINE_COLOR));
    ...
    public interface OnRangeChangeListener {
        void onRangeChange(RangeSlider view, int type, int leftPinIndex, int rightPinIndex);
