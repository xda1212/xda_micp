...
import com.micp.im.interf.BaseViewInterface;
import com.micp.im.interf.DialogControl;
import com.micp.im.ui.dialog.CommonToast;
        ...
        public void onLocationChanged(AMapLocation amapLocation) {
            if (amapLocation != null) {
                if (amapLocation.getErrorCode() == 0) {
                    ...
                    AppContext.city = amapLocation.getCity();
                    PhoneLiveApi.saveInfo(LiveUtils.getFiledJson("city", AppContext.city), getUserID(), AppContext.getInstance().getToken(), null);
