...
import com.micp.im.adapter.ChatListAdapter;
import com.micp.im.adapter.UserListAdapter;
...
import com.micp.im.fragment.LiveEmceeEndFragmentDialog;
import com.micp.im.fragment.LiveEndFragmentDialog;
import com.micp.im.fragment.MessageFragment;
import com.micp.im.fragment.UserInfoDialogFragment;
import com.micp.im.model.Danmu;
import com.micp.im.ui.customviews.ErrorDialogFragment;
import com.micp.im.ui.other.ChatServer;
import com.micp.im.ui.other.DrawableRes;
...
import com.micp.im.widget.MyAnimationDrawable;
import com.micp.im.widget.SpaceRecycleView;
import com.micp.im.widget.VerticalImageSpan;
import com.micp.im.widget.danmu.DanmuControl;
...
public class ShowLiveActivityBase extends ToolBarBaseActivity {
    ...
    protected void showPlainAnimation(final SendGiftBean mSendGiftBean) {
        ...
        RelativeLayout.LayoutParams pa = new RelativeLayout.LayoutParams((int) TDevice.getScreenWidth(), (int) TDevice.getScreenHeight());
        pa.addRule(RelativeLayout.CENTER_IN_PARENT);
        animation.setLayoutParams(pa);
        mLiveContent.addView(animation);

        MyAnimationDrawable.animateRawManuallyFromXML(R.drawable.gift_animation_plane_general,
    ...
    protected void showRedCarAnimation(SendGiftBean sendGiftBean) {
        ...
        MyAnimationDrawable.animateRawManuallyFromXML(R.drawable.gift_animation_car_general,
                animation, new Runnable() {
