...
import com.micp.im.adapter.NearAdapter;
...
import com.micp.im.interf.OnItemClickListener;
import com.micp.im.interf.OnLiveItemClickListener;
...
public class NearFragment extends AbsFragment implements RefreshLayout.OnRefreshListener, OnLiveItemClickListener {
    ...
    private void initView() {
        ...
        mRecyclerView = mRootView.findViewById(R.id.recylcerView);
