...
public class VideoShareFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void shareVideo(int index) {
        try {
            ...
            ShareUtils.share(getActivity(), names, AppConfig.VIDEO_SHARE_TITLE
                    , des, null, mActiveBean.getThumb(), AppConfig.MAIN_URL + "/index.php?g=appapi&m=video&a=index&videoid=" + mActiveBean.getId()
