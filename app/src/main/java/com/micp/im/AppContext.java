...
import com.micp.im.cache.DataCleanManager;
import com.micp.im.event.Event;
import com.micp.im.utils.MethodsCompat;
...
public class AppContext extends BaseApplication {
    ...
    public static int page = 1; //分页 默认为1
